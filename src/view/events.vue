  ...
  <div class="main">
    ...
    <div class="container">
        ...
        <div class="contact">
          ...
          <div class="item">
              <label class="label" style="width:100px">付款方式：</label>
...
<style scoped>
 ...
 .item{padding:5px 80px; font-size: 20px; }
.item .label{width: 90px; line-height: 35px; float: left;}
.item .input{margin-left:90px;min-height: 35px;line-height: 35px;}
.num{position: relative; width: 160px;}
#jian,#jia{position: absolute; width: 36px; height: 34px; text-align: center; font-size: 30px; cursor: pointer; background: #fff; display: block; left: 1px; top: 1px; border-radius: 5px;}
#jia{right: 1px; left:auto;}
 input[type='text']{border:solid 1px #ffcccc; border-radius: 5px;width: 100%; padding: 0 5px; line-height: 35px;}
