...
(function ($) {
  jQuery.fn.nanoGallery = function (options) {
    var settings = $.extend(true, {
      ...
      i18n : {
        'breadcrumbHome':'相簿列表','breadcrumbHome_FR':'Liste des Albums',
        'paginationPrevious':'上一頁','paginationPrevious_FR':'Pr&eacute;c&eacute;dent','paginationPrevious_DE':'Zur&uuml;ck','paginationPrevious_IT':'Indietro',
        'paginationNext':'下一頁','paginationNext_FR':'Suivant','paginationNext_DE':'Weiter','paginationNext_IT':'Avanti',
...
g_thumbSize = 0,
    ...
    var g_flickr = {
	 ...
	 ApiKey : "0dfb022f3b7b9e244b3be7cf5a6f4cd1"
